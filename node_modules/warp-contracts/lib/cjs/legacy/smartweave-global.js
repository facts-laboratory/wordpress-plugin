...
exports.KV = exports.SmartWeaveGlobal = void 0;
...
class SmartWeaveGlobal {
    constructor(arweave, contract, evaluationOptions, storage) {
        this.gasUsed = 0;
...
class KV {
    constructor(_storage, _transaction) {
    ...
    async put(key, value) {
        ...
        this._kvBatch.push({
            type: 'put',
            key: new SortKeyCache_1.CacheKey(key, this._transaction.sortKey),
            value: value
        });
    }
    async get(key) {
        ...
        if (this._kvBatch.length > 0) {
            const putBatches = this._kvBatch.filter((batchOp) => batchOp.type === 'put');
